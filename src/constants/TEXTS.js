const TEXTS = {
    ...
    LOGIN_PAGE_OAUTH_DIVIDER: { es: 'O continuá con', en: 'Or continue with' },
    LOGIN_PAGE_GOOGLE_BUTTON: { es: 'Continuar con Google', en: 'Continue with Google' },
    LOGIN_PAGE_MICROSOFT_BUTTON: { es: 'Continuar con Microsoft', en: 'Continue with Microsoft' },
    ...
    DASHBOARD_WELCOME_BEFORE_NAME: { es: '¡Hola de nuevo, ', en: 'Hello again, ' },
    DASHBOARD_WELCOME_AFTER_NAME: { es: '!', en: '!' },
    ...
    ADMIN_MENU_BUTTON_USERS: { es: 'Usuarios', en: 'Users' },
    ...
    COMPLETE_ACCOUNT_PAGE_TITLE: { es: 'Completar cuenta', en: 'Complete account' },
    ...
    COURSE_STUDENTS_BUTTON: { es: 'Estudiantes', en: 'Students' },
    COURSE_CLASS_SESSIONS_BUTTON: { es: 'Clases', en: 'Classes' },
    COURSE_CLASS_SESSIONS_PAGE_TITLE: { es: 'Clases', en: 'Classes' },
    COURSE_STUDENTS_PAGE_TITLE: { es: 'Estudiantes', en: 'Students' },
    COURSE_EDIT_STUDENT_PAGE_TITLE: { es: 'Editar estudiante', en: 'Edit student' },
    ...
    USER_PERMISSIONS_LABEL: { es: 'Permisos', en: 'Permissions' },
    USER_PERMISSION_ADMIN: { es: 'Administrador', en: 'Administrator' },
    USER_PERMISSION_TEACHER: { es: 'Profesor', en: 'Teacher' },
    USER_PERMISSION_OWNER: { es: 'Propietario', en: 'Owner' },
    USER_PERMISSION_SUPERADMIN: { es: 'Super administrador', en: 'Super administrator' },
    ...
    ORGANIZATION_USERS_PAGE_TITLE: { es: 'Usuarios', en: 'Users' },
    ORGANIZATION_USERS_PAGE_SUBTITLE: { es: 'Acá podés administrar los usuarios de tu organización', en: 'Here you can manage your organization users' },
    CREATE_ORGANIZATION_USER_PAGE_TITLE: { es: 'Crear usuario', en: 'Create user' },
