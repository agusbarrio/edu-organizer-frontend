const TEXTS = {
    ...
    LOGIN_PAGE_REGISTER_LINK: { es: '¿No tenés una cuenta? Regístrate', en: 'Don\'t have an account? Register' },
    ...
    COURSE_PAGE_SUBTITLE: { es: 'Aca podés ver y editar la información del curso', en: 'Here you can see and edit the course information' },
    ...
    CREATE_COURSE_PAGE_SUBTITLE: { es: 'Aca podés crear un nuevo curso', en: 'Here you can create a new course' },
    CREATE_STUDENT_PAGE_TITLE: { es: 'Crear estudiante', en: 'Create student' },
    CREATE_STUDENT_PAGE_SUBTITLE: { es: 'Aca podés crear un nuevo estudiante', en: 'Here you can create a new student' },
    ...
    STUDENT_PAGE_SUBTITLE: { es: 'Aca podés ver y editar la información del estudiante', en: 'Here you can see and edit the student information' },
    ...
    CLASS_SESSIONS_PAGE_SUBTITLE: { es: 'Aca podés ver los registros de asistencia', en: 'Here you can see the attendance records' },
    COURSES_PAGE_TITLE: { es: 'Cursos', en: 'Courses' },
    COURSES_PAGE_SUBTITLE: { es: 'Aca podés ver todos los cursos', en: 'Here you can see all the courses' },
    STUDENTS_PAGE_TITLE: { es: 'Estudiantes', en: 'Students' },
    STUDENTS_PAGE_SUBTITLE: { es: 'Aca podés ver todos los estudiantes', en: 'Here you can see all the students' },
    TEACHERS_PAGE_SUBTITLE: { es: 'Aca podés ver todos los profesores', en: 'Here you can see all the teachers' },
