const TEXTS = {
    ...
    NAME_FIELD_PLACEHOLDER: { es: 'Ingresa el nombre del campo', en: 'Enter the name field' },
    SUBMIT_INPUT_FORM: { es: 'Guardar campo', en: 'Save field' },
    PLACEHOLDER_FIELD_LABEL: { es: 'Placeholder del campo', en: 'Placeholder field' },
    PLACEHOLDER_FIELD_PLACEHOLDER: { es: 'Ingresa el placeholder del campo', en: 'Enter the placeholder field' },
    LABEL_FIELD_LABEL: { es: 'Etiqueta del campo', en: 'Label field' },
    LABEL_FIELD_PLACEHOLDER: { es: 'Ingresa la etiqueta del campo', en: 'Enter the label field' },
    TYPE_FIELD_LABEL: { es: 'Tipo de campo', en: 'Type field' },
    TYPE_FIELD_PLACEHOLDER: { es: 'Ingresa el tipo de campo', en: 'Enter the type field' },
